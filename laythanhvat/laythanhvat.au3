Func _GotoLayThanhVat($Title,$emuport,$Handle)
      ...
      local $p1111 = _searchNV($Handle, $Imagelaythanhvat, 115, 3) ; search NV Lay Thanh Vat Tor = 115 and Scan size = 2
	  If @error Then ; ko tim thay nv out
		 Return SetError(3)
      Else
		 Opt("WinTitleMatchMode", 3)
		 ControlClick($Title, "", "","", 1,$p1111[1][0]+275, $p1111[1][1]+25) ; click toi
		 Sleep(1000)
